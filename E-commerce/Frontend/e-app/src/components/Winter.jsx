...
function Winter() {
  ...
  return (
    <div>
      <img
        src="https://assets.myntassets.com/f_webp,w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2024/10/18/12356b14-759f-4132-bc7e-2d203afc952b1729245835769-Get-Winter-Ready--1-.jpg"
        className="mt-7"
      ></img>
